...
public class StartIntervalCMD implements BukkitCommand {
    @Override public List<String> getAliases() { return Collections.singletonList("start_interval"); }
    @Override public String getPermission() { return "challenges.command.start_interval"; }
    @Override public String getUsage() { return "start_interval"; }
